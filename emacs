...
%s" (eshell/pwd) (if (= (user-uid) 0) " # " " $ "))))
 ...
 '(pgg-gpg-use-agent t)
 '(pop-up-windows nil)
 '(rcirc-bright-nicks (quote ("schmeidi" "nothingmuch" "jeremy" "stevan" "tommy" "Dylan")))
 '(rcirc-default-nick "jrockway")
 '(rcirc-default-server "irc.perl.org")
 '(rcirc-default-user-name "jrockway")
 '(rcirc-keywords (quote ("jrock" "jrockway" "rockway")))
...
(custom-set-faces
 ...
 '(rcirc-keyword ((t (:inherit nil :foreground "turquoise" :weight bold))))
 '(rcirc-track-keyword ((t (:foreground "magenta" :weight bold))))
 '(rcirc-track-nick ((t (:inherit font-lock-keyword-face :inverse-video nil))))
