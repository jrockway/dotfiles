...
(custom-set-faces
 ...
 '(rcirc-keyword ((t (:inherit nil :foreground "green"))))
 '(rcirc-my-nick ((((class color) (min-colors 88) (background dark)) (:foreground "red"))))
 '(rcirc-nick-in-message ((((class color) (min-colors 88) (background dark)) (:foreground "Cyan"))))
 '(rcirc-nick-in-message-full-line ((t nil)))
 '(rcirc-other-nick ((((class color) (min-colors 88) (background dark)) (:foreground "grey"))))
 '(rcirc-prompt ((((min-colors 88) (background dark)) (:foreground "#99ff99"))))
